...
contract Tcu29Pool is Ownable {
    ...
    mapping(address account => uint256 balance) public stakedBal;

    //rewards tracking
    uint256 public totalRewardsPaid;
    mapping(address account => uint256 received) public totalRewardsReceived;
